...
def _lower_tpu_kernel(module: ir.Module, hardware_generation: int) -> ir.Module:
  ...
  Returns:
    A pair containing an MLIR LLO module implementing the kernel specified by
    the argument and a tuple of additional constant arguments that should be
